...
public class ParkingRadarVisualizationPacket implements IParkingRadarVisualizationPacket {
    ...
    public ParkingRadarVisualizationPacket() {
        sources = new Point2D[VisualizationConfig.PARKING_RADAR_SENSORS_COUNT];
        corner1s = new Point2D[VisualizationConfig.PARKING_RADAR_SENSORS_COUNT];
        corner2s = new Point2D[VisualizationConfig.PARKING_RADAR_SENSORS_COUNT];
    }
    /**
