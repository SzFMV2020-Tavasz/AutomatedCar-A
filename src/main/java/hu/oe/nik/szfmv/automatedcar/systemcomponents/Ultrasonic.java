...
public class Ultrasonic {
  ...
  */
    ...
    private List<WorldObject> collidableObjects = new ArrayList<>();
    ...
    private void getCollidableObjectsInSensorRange() {
        collidableObjects = new ArrayList<>();
        for (Sensor sensor :
                sensors) {
            collidableObjects.addAll(world.getObjectsInsideTriangle(sensor.getTriangleSource(), sensor.getTriangleCorner1(),
                    sensor.getTriangleCorner2()));
        }
    }

    public List<WorldObject> getCollidableObjects() {
        getCollidableObjectsInSensorRange();
