...
public class Shitfer {
    ...
    public void increment() {
        ...
        if (acttuallyValue < pos.length - 1) {
            acttuallyValue++;
            virtualFunctionBus.manualCarControlPacket.setShiftChangeRequest(pos[acttuallyValue]);
    ...
    public void decrement() {
        if (acttuallyValue > 0) {
            acttuallyValue--;
            virtualFunctionBus.manualCarControlPacket.setShiftChangeRequest(ShiftPos.values()[acttuallyValue]);
